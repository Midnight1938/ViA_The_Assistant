...
class ViA_GUI():
    ...
    def _setup_main_window(self):
        ...
        head_label = Label(self.window, bg=BG_Colour, fg=Text_Colour,
                                text=ViASide.session_prompt, font=Font_Bold, pady=10) ####!!!! Use Bot Here, switch to instructions
        ...
        ##! Mssg Entry
        self.mssgEntry = Entry(bottom_label, bg=Mssg_colour, fg=Text_Colour, font=Font)
        self.mssgEntry.place(relwidth=0.74, relheight=0.07, rely=0.008, relx=0.011)
        self.mssgEntry.focus()
        self.mssgEntry.bind("<Return>", self.onEnter)
        
            ##! A Send BUtton
        sendBttn = Button(bottom_label, text="Ask ViA", font=Font_Bold, width=20, bg=Bttn_Colour,
